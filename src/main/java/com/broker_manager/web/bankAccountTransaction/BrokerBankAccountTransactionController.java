...
public class BrokerBankAccountTransactionController {
    ...
    public List<BankAccountTransaction> getAllBankAccountTransactionsByUser(@AuthenticationPrincipal AuthorizedUser authUser) {
        ...
        return bankAccountTransactionService.getAllBankAccountTransactionsByUser(authUser.getUser());
    }
    ...
    public BankAccountTransaction createBankAccountTransaction(@Valid @RequestBody Stock stock, Integer amountStock, Operation operation,
        ...
        return bankAccountTransactionService.createBankAccountTransaction(stock, amountStock, operation, authUser.getUser());
    }
}
